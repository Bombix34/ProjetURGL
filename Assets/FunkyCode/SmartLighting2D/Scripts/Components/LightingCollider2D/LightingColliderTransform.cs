...
public class LightingColliderTransform {
	...
	public void Update() {
		...
		bool checkShapeSprite = shape.maskType == LightingCollider2D.MaskType.SpriteCustomPhysicsShape || shape.shadowType == LightingCollider2D.ShadowType.SpriteCustomPhysicsShape;
		bool checkMaskSprite = shape.maskType == LightingCollider2D.MaskType.Sprite || shape.maskType == LightingCollider2D.MaskType.BumpedSprite;
