...
public class DayLightingColliderTransform {
	...
	public void Update() {
		...
		if (shape.shadowType == DayLightingCollider2D.ShadowType.SpriteCustomPhysicsShape) {
...
public class DayLightingTilemapColliderTransform {
	public bool moved = false;
	...
	public void Update(DayLightingTilemapCollider2D id) {		
