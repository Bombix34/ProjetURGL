...
namespace Rendering.Night {
	...
	public class LightMesh {
       ...
       static public void Draw(LightMesh2D id, Camera camera, float z) {
            ...
            for(int i = 0; i < pointsCount; i++) {
               ...
               // float c = ((float)i) / pointsCount * 41;
                ...
                if (id.useUV) {
                    ...
                    GL.Vertex3 (pointA.x, pointA.y, z);

                    GL.TexCoord3 (uvB.x, uvB.y, 0);
                    GL.Vertex3 (pointB.x, pointB.y, z);

                    GL.TexCoord3 (uvC.x, uvC.y, 0);
                    GL.Vertex3 (pos.x  + offset.x, pos.y + offset.y, z);
