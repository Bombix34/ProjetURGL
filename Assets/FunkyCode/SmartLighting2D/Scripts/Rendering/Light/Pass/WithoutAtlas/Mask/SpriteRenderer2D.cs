...
namespace Rendering.Light.WithoutAtlas {
    ...
    public class SpriteRenderer2D {
        ...
        public static void Mask(LightingSource2D light, LightingCollider2D id, Material material, LayerSetting layerSetting, float z) {
        ...
        public static void MaskNormalMap(LightingSource2D light, LightingCollider2D id, Material material, LayerSetting layerSetting, float z) {
            if (id.InLightSource(light) == false) {
                return;
            }
