...
public class GUISortingLayer {
	...
	static public void Draw(SerializedObject serializedObject, LightingSettings.SortingLayer sortingLayer) {
...
public class GUIMeshMode {
    ...
    public static void Draw(SerializedObject serializedObject, MeshMode meshMode) {
		...
		if (meshModeShader.intValue == (int)MeshMode.MeshModeShader.Custom) {
		...
		GUISortingLayer.Draw(serializedObject, meshMode.sortingLayer);
