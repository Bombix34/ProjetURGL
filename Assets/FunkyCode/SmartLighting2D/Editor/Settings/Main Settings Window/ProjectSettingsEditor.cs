...
public class ProjectSettingsEditor {
    ...
    public class EditorView {
        public static void Draw(LightingSettings.ProjectSettings mainProfile) {
            ...
            mainProfile.sceneView.drawGizmos = (LightingSettings.EditorView.DrawGizmos)EditorGUILayout.EnumPopup("Draw Gizmos", mainProfile.sceneView.drawGizmos);

            mainProfile.sceneView.drawGizmosBounds = (LightingSettings.EditorView.GizmosBounds)EditorGUILayout.EnumPopup("Gizmos Bounds", mainProfile.sceneView.drawGizmosBounds);
