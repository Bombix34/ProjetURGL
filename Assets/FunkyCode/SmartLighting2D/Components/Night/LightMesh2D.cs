...
public class LightMesh2D : MonoBehaviour {
    ...
    public LightingLayer lightLayer = LightingLayer.Layer1;
    ...
    static public List<LightMesh2D> GetList() => list;
    private static List<LightMesh2D> list = new List<LightMesh2D>();

	public LightMeshTransform transform2D = new LightMeshTransform();

	public List<LightingCollider2D> collidersInside = new List<LightingCollider2D>();
	public List<LightingCollider2D> collidersInsideRemove = new List<LightingCollider2D>();
